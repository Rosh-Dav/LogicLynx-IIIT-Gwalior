    ...
    cyberpunk: [
      {
        ...
        tutorial: "A variable is like an empty data chip. You must assign it a specific label so the framework knows how to reference it using an equals sign. For example, `status = 1` stores the number 1 inside the label 'status'.",
    ...
    fantasy: [
      {
        ...
        tutorial: "Think of a variable as an ancient magical vessel. You must grant it a true name, and then fill it with energy using an equals sign. For example, `runes = 1` binds the number 1 to the word 'runes'.",
    ...
    cyberpunk: [
      {
        id: 1,
        title: "Initialize System Grid",
        tutorial: "A variable is like an empty data chip. You must first declare its data type (like `int`) and label, then assign it using an equals sign. For example, `int status = 1;` initializes the integer 1 into 'status'.",
        story: "You enter the neon-lit back alley connecting to the central mainframe. Your cybernetic implant buzzes. 'We need to bypass the gateway protocol,' whispers your handler. 'Declare an access token to proceed.'",
        objective: "Declare an integer variable named `access_token` and set it to 1010.",
    ...
    fantasy: [
      {
        id: 1,
        title: "The First Enchantment",
        tutorial: "Think of a variable as an ancient magical vessel. You must decree its composition (like `int`), grant it a true name, and fill it using an equals sign. For example, `int runes = 1;` binds 1 into the 'runes' vessel.",
        story: "The ancient tome reveals its secrets in glowing runes. 'Before drawing power from the leylines, an apprentice must center their core,' reads the master archmage. 'Focus your mana.'",
        objective: "Declare an integer variable named `mana_core` and set it to 1010.",
